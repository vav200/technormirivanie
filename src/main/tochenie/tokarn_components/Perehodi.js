...
function Perehodi() {
  ...
  function addosnperehod() {
    dispatch({ type: "ADDPEREHOD_TOKARNOVINTOREZN", data: ["Основной переход"] });
  }
  function addvspperehod() {
    dispatch({ type: "ADDPEREHOD_TOKARNOVINTOREZN", data: ["Вспомагательный переход"] });
  }
  function delnperehod() {
    dispatch({ type: "DELPEREHOD_TOKARNOVINTOREZN", data: massivperehtodel });
    setMassivperehtodel(() => []);
  }
  ...
  return (
    <div className="infoblock">
            ...
            <div className="accordion-item relativ">
              <div className="checkperehod">
                <input
                  ...
                  disabled={
                    index == 0 && statenow.perehods[index][0] === "Вспомагательный переход"
                      ? true
                      : false
                  }
                />
      ...
      <div className="d-flex flex-lg-row flex-column gap-2">
        <button type="button" className="btn btn-outline-secondary w-100" onClick={addvspperehod}>
